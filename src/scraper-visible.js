...
async function main() {
    ...
    console.log('========================================================');
    console.log('  OPTIMIZED SVG Icon Scraper - VISIBLE BROWSER MODE');
    console.log('  5-8x FASTER with Multiple Browser Tabs');
    console.log('  Watch all tabs working simultaneously!');
    ...
    console.log('Launching browser in VISIBLE mode with multiple tabs...');
    console.log('👀 You can watch all tabs working simultaneously!\n');
